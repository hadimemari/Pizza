...
export const PizzaCarousel: React.FC<PizzaCarouselProps> = ({ pizzas, activeIndex, onPizzaClick }) => {
  // محاسبات دقیق مدار دایره‌ای برای چرخشی نرم و حرفه‌ای
  const radius = 700; 
  ...
  return (
    <div className="relative w-full h-full flex items-center overflow-visible select-none">
      {/* مرکز دایره در خارج از کادر سمت چپ قرار دارد تا پیتزاها به صورت منحنی وارد شوند */}
      <div 
        ...
        {pizzas.map((pizza, index) => {
          ...
          return (
            <div
              ...
              className={cn(
                "absolute top-1/2 left-1/2 cursor-pointer transition-all duration-[1200ms] ease-out origin-center",
            ...
            >
              <div className="relative group perspective-2000">
                {/* هاله نورانی پشت پیتزای فعال */}
                {isActive && (
                  <div className="absolute inset-0 bg-primary/30 rounded-full blur-[120px] animate-pulse" />
                )}
                
                <div className={cn(
                  "relative transition-all duration-[1500ms] ease-[cubic-bezier(0.23,1,0.32,1)]",
